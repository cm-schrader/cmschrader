...
const Thoth = new Astro.Body(scene, "Thoth", Wolf, Astro.Planet, Re*1.2, Me*2, Au*.055, 1.578690, 0.0067086, 10, 204.873, 88.1, 0x264de4)
// The capital of Wolf

const Horus = new Astro.Body(scene, "Horus", Wolf, Astro.Planet, 3.0964*Re, 43.9072*Me, .085*Au, -1, 0.06, 2000, 110, 120.1, 0xcccccc)
